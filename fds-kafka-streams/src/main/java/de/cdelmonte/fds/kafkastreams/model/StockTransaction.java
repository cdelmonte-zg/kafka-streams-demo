...
public class StockTransaction {
  ...
  public static StockTransaction reduce(StockTransaction transactionOne,
      StockTransaction transactionTwo) {
  ...
  public String toString() {
    return "StockTransaction{" + "symbol='" + symbol + '\'' + ", sector='" + sector + '\''
        + ", shares=" + shares + ", sharePrice=" + sharePrice + ", customerId='" + customerId + '\''
        + ", transactionTimestamp=" + transactionTimestamp + ", purchase=" + purchase + '}';
  }
  ...
  public boolean equals(Object o) {
    ...
    if (customerId != null ? !customerId.equals(that.customerId) : that.customerId != null)
      return false;
    return transactionTimestamp != null ? transactionTimestamp.equals(that.transactionTimestamp)
        : that.transactionTimestamp == null;
  }
