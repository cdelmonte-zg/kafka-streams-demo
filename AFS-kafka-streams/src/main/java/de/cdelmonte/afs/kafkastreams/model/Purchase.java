...
public class Purchase {
  ...
  public boolean equals(Object o) {
    ...
    if (quantity != purchase.quantity)
      return false;
    if (Double.compare(purchase.price, price) != 0)
      return false;
    if (firstName != null ? !firstName.equals(purchase.firstName) : purchase.firstName != null)
      return false;
    if (lastName != null ? !lastName.equals(purchase.lastName) : purchase.lastName != null)
      return false;
    if (customerId != null ? !customerId.equals(purchase.customerId) : purchase.customerId != null)
      return false;
    if (creditCardNumber != null ? !creditCardNumber.equals(purchase.creditCardNumber)
        : purchase.creditCardNumber != null)
      return false;
    if (itemPurchased != null ? !itemPurchased.equals(purchase.itemPurchased)
        : purchase.itemPurchased != null)
      return false;
    if (department != null ? !department.equals(purchase.department) : purchase.department != null)
      return false;
    if (employeeId != null ? !employeeId.equals(purchase.employeeId) : purchase.employeeId != null)
      return false;
    if (zipCode != null ? !zipCode.equals(purchase.zipCode) : purchase.zipCode != null)
      return false;
  ...
  public String toString() {
    return "Purchase{" + "firstName='" + firstName + '\'' + ", lastName='" + lastName + '\''
        + ", customerId='" + customerId + '\'' + ", creditCardNumber='" + creditCardNumber + '\''
        + ", itemPurchased='" + itemPurchased + '\'' + ", department='" + department + '\''
        + ", employeeId='" + employeeId + '\'' + ", quantity=" + quantity + ", price=" + price
        + ", purchaseDate=" + purchaseDate + ", zipCode='" + zipCode + '\'' + ", storeId='"
        + storeId + '\'' + '}';
  }
