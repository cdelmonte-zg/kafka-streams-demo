package de.cdelmonte.afs.kafkastreams.collectors;
...
/**
 * Class that acts as a priority queue but has a fixed size. When the maximum number of elements is
 * reached the lowest/highest element will be removed.
 */
